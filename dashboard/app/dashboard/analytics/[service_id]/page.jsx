...
const [heatmapData, setHeatmapData] = useState([]);
  ...
  const fetchData = async () => {
    const endpoint =
      filter === "month"
        ? "/api/analyze/metrics/monthly_trafic"
        : "/api/analyze/metrics/hourly_trafic";
  ...
  useEffect(()=>{
    const fetch_log_level_count=async()=>{
      try {
        ...
        const res=await fetch('/api/analyze/level_count',{
          method:"POST",
          headers:{
    ...
    const fetch_current_traffic=async()=>{
      try {
        const res=await fetch('/api/analyze/traffic-meter',{
          method:"POST",
          credentials:'include',
          headers:{
            'content-type':'application/json'
    ...
    const fetch_users_location_data=async()=>{
      try {
        ...
        const res=await fetch('/api/analyze/metrics/log_locations',{
          method:"POST",
          headers:{
            "content-type":"application/json"
          },
    ...
    const fetch_total_counts=async()=>{
      try {
        ...
        const res=await fetch('/api/analyze/metrics/total_service_logs',{
          method:"POST",
          credentials:"include",
          headers:{
            "content-type":"application/json"
    ...
    const fetch_all_logs=async()=>{
      try {
        ...
        const res=await fetch('/api/analyze/display_top_logs',{
          method:"POST",
          headers:{
            "content-type":"application/json"
          },
    ...
    const fetchDailyData=async()=>{
      try {
        const res=await fetch("/api/analyze/metrics/daily_traffic",{
          method:"POST",
          headers:{
            "content-type":"application/json"
          },
